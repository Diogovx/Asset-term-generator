...
@patch("core.document_processor.LAPTOP_TEMPLATE_PATH", Path("fake_laptop_template.docx"))
@patch("core.document_processor.SMARTPHONE_TEMPLATE_PATH", Path("fake_smartphone_template.docx"))
